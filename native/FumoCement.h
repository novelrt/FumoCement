...
namespace FumoCement
{
	...
	*/
	...
	inline const char* passAsC(const std::optional<std::string>& cppString) noexcept
	{
		if (!cppString)
		{
			return nullptr;
		}
		return cppString.value().c_str();
	}
...
#pragma region DoubleIndirectedPointer
	/*
 * Class:     com_github_novelrt_fumocement_DoubleIndirectedPointer
 * Method:    getNativeUnderlyingHandle
 * Signature: (J)J
 */
	JNIEXPORT jlong JNICALL Java_com_github_novelrt_fumocement_DoubleIndirectedPointer_getNativeUnderlyingHandle
	(JNIEnv*, jclass, jlong handle)
	{
	 ...
	 * Signature: (JJ)J
	 */
	JNIEXPORT jlong JNICALL Java_com_github_novelrt_fumocement_DoubleIndirectedPointer_setNativeUnderlyingHandle
	(JNIEnv*, jclass, jlong handle, jlong value)
	{
	 ...
	 * Signature: ()J
	 */
	JNIEXPORT jlong JNICALL Java_com_github_novelrt_fumocement_DoubleIndirectedPointer_createPointer
	(JNIEnv*, jclass)
	{
	 ...
	 * Signature: (J)V
	 */
	JNIEXPORT void JNICALL Java_com_github_novelrt_fumocement_DoubleIndirectedPointer_destroyPointer
	(JNIEnv*, jclass, jlong handle)
	{
